...
async function validarNombre(nombreValidado, callback) {
    let valida = true;
...
async function validarPassword(passwordValidada, callback) {
...
async function validarEmail(valor, callback) {
...
async function validarFecha(valor, callback) {
